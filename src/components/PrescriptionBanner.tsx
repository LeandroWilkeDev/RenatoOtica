...
export default function PrescriptionBanner({
  ...
  const whatsappHref = buildWhatsAppUrl(whatsappNumber, message);

  return (
    <section className="reveal-group mt-6 pt-16 sm:pt-0">
      <article className="reveal-item relative overflow-hidden rounded-none sm:rounded-[2.5rem] border border-teal-500/30 bg-linear-to-r from-slate-50 via-white to-slate-100 p-8 shadow-lg dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-800 dark:border-teal-400/30">
