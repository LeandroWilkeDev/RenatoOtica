...
import armacaoPhoto from "./assets/armacao.jpg";
  ...
  return (
    <>
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-[100vw] sm:max-w-7xl flex-col px-0 py-0 sm:px-8 sm:py-8 lg:px-12 selection:bg-teal-500/30 overflow-hidden">
        ...
        <section className="reveal-group mt-6 grid gap-6 lg:grid-cols-2">
          <article className="reveal-item glass-card group overflow-hidden rounded-none sm:rounded-[2.5rem] p-8 transition-all hover:bg-slate-100/50 hover:dark:bg-white/[0.04] border-transparent hover:border-teal-500/20 hover:dark:border-teal-500/30">
            <div className="flex flex-col h-full">
              ...
              <p className="mt-3 text-base leading-relaxed text-slate-600 dark:text-zinc-400 font-light">
                Modelos premium e ultraleves para destacar sua personalidade com conforto no
                dia a dia e preço acessível.
              </p>
              ...
              <div className="mt-8 overflow-hidden rounded-3xl relative mt-auto border border-teal-900/10 dark:border-white/5 shadow-md dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)]">
                ...
                <img
                  src={armacaoPhoto}
                  alt="Pessoa usando oculos de grau moderno"
                ...
                <div className="absolute bottom-6 left-6 z-20 translate-y-4 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
                  <span className="inline-flex rounded-full bg-white/20 backdrop-blur-md px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-white border border-white/30">
                    Ver Coleção
                  </span>
                </div>
              </div>
          ...
          <article className="reveal-item glass-card group overflow-hidden rounded-none sm:rounded-[2.5rem] p-8 transition-all hover:bg-slate-100/50 hover:dark:bg-white/[0.04] border-transparent hover:border-teal-500/20 hover:dark:border-teal-500/30">
            <div className="flex flex-col h-full">
              ...
              <p className="mt-3 text-base leading-relaxed text-slate-600 dark:text-zinc-400 font-light">
                Na compra do seu óculos completo. Oftalmo com equipamento digital para medição precisa e recomendação ideal.
              </p>
          ...
          <article className="reveal-item glass-card relative overflow-hidden rounded-none sm:rounded-[2.5rem] p-8 sm:p-12 border-teal-500/20 dark:border-teal-500/30 transition-transform duration-500 hover:translate-y-[-4px]">
            ...
            <div className="relative grid items-center gap-8 md:grid-cols-[1fr_1fr]">
              <div className="order-2 md:order-1 md:pr-4">
                <p className="inline-flex rounded-full border border-teal-500/30 bg-teal-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-[0.16em] text-teal-700 dark:text-teal-300">
                  Oferta Especial
                </p>
                <h2 className="font-title mt-5 text-3xl font-extrabold leading-tight text-zinc-900 dark:text-white sm:text-4xl">
                  Lentes Premium <br />
                  <span className="text-teal-600 dark:text-teal-400">
                    + 30% OFF na 2ª armação
                  </span>
                </h2>
                <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-700 dark:text-zinc-300 font-light">
                  Válido até o fim do mês para novos clientes. Agende agora e faça sua
                  consultoria visual completa no melhor padrão.
                </p>
                <a
                  href={whatsappHref}
                  target="_blank"
                  rel="noreferrer"
                  className="mt-8 inline-flex items-center justify-center w-full sm:w-auto rounded-full bg-zinc-900 text-white dark:bg-white dark:text-zinc-950 px-8 py-3.5 text-sm font-bold transition-all hover:bg-teal-500 hover:text-white dark:hover:bg-teal-400 hover:scale-105"
                >
                  Resgatar Promoção
                </a>
              </div>
              ...
              <div className="order-1 md:order-2 relative justify-self-center md:justify-self-end mb-6 md:mb-0 group">
                ...
                <img
                  ...
                  className="relative z-10 mx-auto h-72 w-full max-w-[280px] rounded-3xl object-cover shadow-xl dark:shadow-[0_20px_40px_rgba(0,0,0,0.6)] border border-teal-900/10 dark:border-white/10 transition-transform duration-500 group-hover:scale-[1.02]"
                  loading="lazy"
                />
              </div>
            </div>
          ...
          <article className="reveal-item glass-card rounded-none sm:rounded-[2.5rem] p-8 sm:p-10 transition-transform duration-500 hover:translate-y-[-4px]">
            <div className="mb-6">
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600 dark:text-zinc-400 font-light max-w-sm">
                Av. Paulista, 900 - Bela Vista, São Paulo - SP <br />
                <span className="text-teal-600 dark:text-teal-300 font-medium mt-2 inline-block">Segunda a Sábado: 09h às 19h</span>
              </p>
            </div>
            ...
            <div className="overflow-hidden rounded-3xl border border-teal-900/10 dark:border-white/10 shadow-lg group">
              <iframe
                ...
                src="https://www.google.com/maps?q=Av.+Paulista,+900,+Sao+Paulo&output=embed"
                width="100%"
                height="300"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                className="grayscale opacity-80 transition-all duration-500 group-hover:grayscale-0 group-hover:opacity-100 dark:invert-[0.9] dark:contrast-[0.8] dark:hue-rotate-180 group-hover:dark:invert-0 group-hover:dark:contrast-100 group-hover:dark:hue-rotate-0"
              />
            </div>
          </article>
          ...
          <article className="reveal-item glass-card rounded-none sm:rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-center relative overflow-hidden transition-transform duration-500 hover:translate-y-[-4px]">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-3 text-base text-slate-600 dark:text-zinc-400 font-light mb-8 max-w-sm">
                Deixe seus dados e nossa equipe de especialistas entrará em contato com você via WhatsApp.
              </p>
        ...
        <footer className="reveal-group flex flex-col items-center gap-1 text-center px-6 py-10 text-sm text-slate-500 dark:text-zinc-500 border-t border-slate-200 dark:border-white/5 mt-4 group">
          <span className="reveal-item transition-colors group-hover:text-slate-700 dark:group-hover:text-zinc-400">© {new Date().getFullYear()} Renato Óculos. Excellence in Vision.</span>
          <span className="reveal-item mt-2 text-xs opacity-80">
            Desenvolvido por{" "}
            <a 
              href="https://portifolio-v6mj.vercel.app/" 
              target="_blank" 
              rel="noreferrer"
